...
export default function AddExerciseManagement() {
    ...
    async function handleAddExercise() {
        ...
        try {
            const response = await fetch(POST_EXERCISE_URL, {
                method: 'POST',
                headers: {
                    'Authorization': token,
                        ...
                        <div sx={{
                            ...
                            <div style={StyleSheet.profileBox}>
                                <div style={StyleSheet.infoContainer}>
                                    ...
                                    <div style={StyleSheet.inputDiv}>
                                        <p><strong>Right Keypoint 1:</strong></p>
                                        <input
                                            type="number"
                                    ...
                                    <div style={StyleSheet.inputDiv}>
                                        <p><strong>Right Keypoint 2:</strong></p>
                                        <input
                                            type="number"
                                    ...
                                    <div style={StyleSheet.inputDiv}>
                                        <p><strong>Right Keypoint 3:</strong></p>
                                        <input
                                            type="number"
                                    ...
                                    <div style={StyleSheet.inputDiv}>
                                        <p><strong>Right Keypoint Distance 1:</strong></p>
                                        <input
                                            type="number"
                                    ...
                                    <div style={StyleSheet.inputDiv}>
                                        <p><strong>Right Keypoint Distance 2:</strong></p>
                                        <input
                                            type="number"
                                    ...
                                    <div style={StyleSheet.inputDiv}>
                                        <p><strong>Left Keypoint 1:</strong></p>
                                        <input
                                            type="number"
                                    ...
                                    <div style={StyleSheet.inputDiv}>
                                        <p><strong>Left Keypoint 2:</strong></p>
                                        <input
                                            type="number"
                                    ...
                                    <div style={StyleSheet.inputDiv}>
                                        <p><strong>Left Keypoint 3:</strong></p>
                                        <input
                                            type="number"
                                    ...
                                    <div style={StyleSheet.inputDiv}>
                                        <p><strong>Left Keypoint Distance 1:</strong></p>
                                        <input
                                            type="number"
                                    ...
                                    <div style={StyleSheet.inputDiv}>
                                        <p><strong>Left Keypoint Distance 2:</strong></p>
                                        <input
                                            type="number"
                                    ...
                                    <div style={StyleSheet.inputDiv}>
                                        <p><strong>Upper Angle Max:</strong></p>
                                        <input
                                            type="number"
                                    ...
                                    <div style={StyleSheet.inputDiv}>
                                        <p><strong>Upper Angle Min:</strong></p>
                                        <input
                                            type="number"
                                    ...
                                    <div style={StyleSheet.inputDiv}>
                                        <p><strong>Lower Angle Max:</strong></p>
                                        <input
                                            type="number"
                                    ...
                                    <div style={StyleSheet.inputDiv}>
                                        <p><strong>Lower Angle Min:</strong></p>
                                        <input
                                            type="number"
                                    ...
                                    <div style={StyleSheet.inputDiv}>
                                        <p><strong>Recognition Type:</strong></p>
                                        <input
                                            type="text"
